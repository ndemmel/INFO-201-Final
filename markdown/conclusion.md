...
Deriving policy implications just from our visualizations can be a bit tricky considering the limitations above. Instead, our hope is that our visualizations provoke the need for more actions, including further research, aimed towards solving the issue of hate crimes.  
